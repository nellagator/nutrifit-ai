  ...
  return (
    <DashboardLayout>
      ...
      <div className="mt-3 grid grid-cols-2 gap-3">
          ...
          <div className="mt-2 flex items-center gap-3 rounded-lg border border-gray-200 p-2 dark:border-gray-700">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Build strength and tone your upper
                body with this workout
              </p>
            </div>
        ...
        <section>
          <div className="rounded-lg border border-gray-200 bg-white p-2 shadow-sm dark:border-gray-700 dark:bg-[#222222]">
            <div className="flex items-center justify-between">
